  ...
  return (
    <article className='shadow my-4'>
      ...
      <div className='bg-white flex flex-col justify-start p-6'>
        ...
        <Link href={article.title} className='text-slate-900 text-3xl font-bold hover:text-gray-700 pb-4'>{article.title}</Link>
        <p className='text-sm text-slate-900 pb-3'>{article.createdAt}</p>
        <a href={article.title} className='text-slate-900 pb-6'>
